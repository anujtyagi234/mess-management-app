...
//           <h1 className="text-5xl font-bold sans-serif mt-0 text-rose-900	color: rgb(225 29 72) ">Create Account</h1>

//           <img src={img} alt="Image" className='rounded-full' style={{ height: "450px", width: "500px", margin: "30px auto 0 auto"}} /> 
//           </div>
//         </div>
//         <div className='h-screen bg-neutral-800 w-1/2  flex-col  juendstify- rounded-r-lg flex justify-center items-center  '>
//           <div className="text-white text-center">
//             <h1 className="text-5xl  " style={{ fontFamily: "sans-serif ", fontWeight: "bold" }}>!! Welcome !!</h1>
//           </div>
//           <div className=" bg-stone-100   rounded-3xl   text-black" style={{ height: "500px", width: "480px", margin: "30px auto 0 auto" }}>
...
//                     <span class="relative" onSubmit={handleLogin}>Sign up</span>
//                   </span>
...
//             </div>
//           </div>
//           <a href="/forgot-password" style={{ color: 'white', textDecoration: 'underline', fontSize: '17px', fontWeight: "bold" }}>
//             Forgot Password?
//           </a>
//         </div>
//       </div>
